...
<p class="sp-layer slider-button" 
    ...
    data-show-transition="left" data-hide-transition="left"
    data-show-delay="800" data-hide-delay="800" data-slide="prev">
</p>
...
<p class="sp-layer slider-button" 
    data-position="leftCenter" data-horizontal="15" data-vertical="300" 
    data-show-transition="left" data-hide-transition="left"
    data-show-delay="800" data-hide-delay="800" data-slide="next">
</p>
...
<div class="sp-slide">
<img class="sp-image" src="{{asset('css/images/blank.gif')}}" alt=""
data-src="{{asset('images/umusambi.jpeg')}}" />
<div class="container">
...
<p class="sp-layer slider-text" 
    data-position="leftCenter" data-horizontal="15" data-vertical="80" 
    data-show-transition="left" data-hide-transition="left"
    data-show-delay="300" data-hide-delay="600">
    We Want to be part of a community
    Which likes for the welfare of others
</p>
...
<h3>Remainders On Medicines</h3>
</div>
<div class="service-text">
Your Regular medicine intake will be reminded to you.
</div>
</div>
...
<h2 class="section-title"><span class="bold700">ABOUT</span> e-Hospital</h2>
<p>e-Hospital is a electronic system that will provide health service from interconnecting hospitals,work with extisting system to provide a unified system where most of health service can be derivered.</p>
<ul class="text-list">
