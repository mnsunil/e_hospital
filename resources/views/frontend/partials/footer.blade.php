            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-item footer-item-1">
                        <h3 class="footer-title footer-title-line"><i class="fa fa-twitter"></i> Latest Facilities</h3>
                        <div class="container">
                            <ul class="menu">
...
<!--                            <div class="tweet-login">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-item footer-item-2">
                        ...
                        <h3 style="color:white;font-family: 'Sansita', sans-serif;">CR MEDICLINIC:</h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-item footer-item-3" id="footer-item-3">
                        ...
                        <div class="footer-item-3-phone">
                            <i class="fa fa-phone"></i> +91-7894561232
                        </div>
                        <div class="footer-item-3-location">
                            <i class="flaticon-navigation-arrow"></i> Vinay Kumar
                        </div>
                        <div class="footer-item-3-mail">
                            <i class="fa fa-envelope"></i> <a href="#">mail@cds.com</a>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-copyright">
                        <div>
                            <center>Copyright &copy; {{date('Y')}} <a href="#" target="_blank">e-Hospital</a> &nbsp;&nbsp;&nbsp;Product of &nbsp;<a href="#" target="_blank">Marlabs</a></center>
                        </div>
                    </div>
                </div>
            </div>
