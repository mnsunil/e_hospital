...
<meta name="description" content="e-Hospital online & offline health  services">
<meta name="keywords" content=e-Hospital, Smart, Health system">
...
<!--=========================
      FAV AND TOUCH ICONS  
========================= -->
<link rel="shortcut icon" href="{{asset('images/favicon_hospital.ico')}}">
        ...
        <div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                <div class="header-logo">
                    <a href="#"><img src="{{asset('images/oooo.plus_38.png')}}" alt="" />
                        <span class="bold600 color-child-6"></span><span class="color-child-5">e-Hospital</span>
                    </a>
                </div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="mobile-bar-cont">
                    <div class="top-menu-logo">
                        <a href="#"><img src="{{asset('images/oooo.plus_38.svg')}}" alt="" />
                            <span class="bold600 color-child-6">e-</span><span class="color-child-5">Hospital</span>
                        </a>
                    </div>
